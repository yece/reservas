...
public class DashboardView extends VerticalLayout implements View {
    ...
    public DashboardView() {
        ...
        addComponent(top);
        final Label title = new Label("Administraci髇");
        ...
        notify.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ((Reserva_inicialjpaUI) getUI()).clearDashboardButtonBadge();
        ...
        edit.addClickListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                w.setContent(new VerticalLayout() {
                    TextField name = new TextField("Administraci髇 nombre");
                    {
        ...
        //row.addComponent(createPanel((Component) new TopGrossingMoviesChart()));
      ...
      //  row.addComponent(createPanel((Component) new TopSixTheatersChart()));
...
LoginController cc= new LoginController();
        ...
        label = new Label("<hr><b>" + cc.login().getUsuarioBean().getNombre() + " "
